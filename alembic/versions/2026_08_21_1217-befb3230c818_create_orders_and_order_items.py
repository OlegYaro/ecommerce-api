...
Revision ID: befb3230c818
Revises: babeaa65cd4d
Create Date: 2026-08-21 12:17:12.198667
...
revision: str = 'befb3230c818'
down_revision: Union[str, Sequence[str], None] = 'babeaa65cd4d'
...
def upgrade() -> None:
    ...
    sa.Column('billing_information', sa.Text(), nullable=False),
